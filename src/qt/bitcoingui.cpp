...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to an Photonic Bitcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Photonic Bitcoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your pBTC addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified pBTC addresses"));
    ...
    openAction->setStatusTip(tr("Open an pBTC: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible pBTC command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Photonic Bitcoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
