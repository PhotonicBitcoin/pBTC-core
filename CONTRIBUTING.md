Contributing to Photonic Bitcoin Core
============================

The Photonic Bitcoin Core is based on the Bitcoin Core. The project operates an open
contributor model where anyone is welcome to contribute towards development in
the form of peer review, testing and patches. This document explains the
practical process and guidelines for contributing.
...
First and foremost we rely on Github issues for communication.
...
Whether a pull request is merged into Photonic Bitcoin Core rests with the project merge
...
Patches that change Photonic Bitcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Photonic Bitcoin consensus, it must have been
...
The project leader is the release manager for each Photonic Bitcoin Core release.
...
This project would be impossible without the Bitcoin Core. We thank the Bitcoin Core
contributors for their effort.
